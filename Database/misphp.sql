...
--
-- Table structure for table `mis_pesoclient`
--

CREATE TABLE `mis_pesoclient` (
  `pes_id` int(20) NOT NULL,
  `pes_fname` varchar(200) DEFAULT NULL,
  `pes_lname` varchar(200) DEFAULT NULL,
  `pes_dob` varchar(200) DEFAULT NULL,
  `pes_age` varchar(200) DEFAULT NULL,
  `pes_number` varchar(200) DEFAULT NULL,
  `pes_addr` varchar(200) DEFAULT NULL,
  `pes_phone` varchar(200) DEFAULT NULL,
  `pes_type` varchar(200) DEFAULT NULL,
  `pes_date_joined` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  `pes_ailment` varchar(200) DEFAULT NULL,
  `pes_discharge_status` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
