                            ...
                            <div class="row">
                                <div class="col-lg-4 col-xl-4">
                                    <div class="card-box text-center">
                                        ...
                                        <p class="text-muted">@System_Administrator_MIS</p>
                                            ...
                                            <div class="tab-pane" id="settings">
                                                <form method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <!-- <input type="checkbox" id="inputoldpassword" onclick="myFunction()">Show Password -->
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="inputnewpassword">New Password</label>
                                                                <input type="password" class="form-control" name="ad_pwd" id="newpinputnewpasswordass" placeholder="Enter New Password">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" class="form-control" id="myInput" placeholder="Confirm New Password">
