...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_user']))
		{
			...
			$query="INSERT INTO mis_user (user_fname, user_lname, user_email, user_number, user_pwd, user_dept, user_dpic) values(?,?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssss', $user_fname, $user_lname, $user_email, $user_number, $user_pwd, $user_dept, $user_dpic);
			$stmt->execute();
			/*
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">User Employee</a></li>
                                            <li class="breadcrumb-item active">Add User Employee</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Add User Employee Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                 <div class="form-group col-md-6">
                                                       ...
                                                       <input required="required" type="text" name="user_dept" class="form-control"  id="inputdepartment" placeholder="Department">
                                                 </div>
                                                 <div class="form-group col-md-6">
                                                    <label for="inputpassword" class="col-form-label">Password</label>
                                                    <input required="required" type="password" name="user_pwd" class="form-control" id="inputpassword" placeholder="Password">
                                                </div>
                                            </div>
