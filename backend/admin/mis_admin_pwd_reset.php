<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['reset_pwd']))
		{
			...
			$query="INSERT INTO mis_pwdresets (email, user_pwd) VALUES(?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ss', $email, $user_pwd);
			$stmt->execute();
			/*
                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="mis_admin_reset_pwd.php">
                                        <span><img src="assets/images/Peso_log.png" alt="" height="50"></span>
                                    </a>
