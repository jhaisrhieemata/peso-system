                ...
                <div class="card-box text-center">
                    <div class="certificate">
                        ...
                        <div style="text-align: center;">
                            ...
                            <span>
                                <h5>
                                    <p style="text-align: justify;">REGISTRY THIS IS TO CERTIFY THAT the above named person has been entered in the MANPOWER SKILLS of
                                        ...
                                        <br><br>
                                    <h2 style="text-align: center;"><u><?php echo $row->agency_name; ?></u></h2>
                                    <br>
                            ...
                            <h5 style="text-align: justify;">
                                <p>OR NO: <?php echo $row->or_no; ?><br>DATE ISSUED: <?php echo $row->date_joined; ?></p>
                            </h5>
                    ...
                    <div class="no-print">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" name="agency_name" required="required" class="form-control" value="<?php echo $row->agency_name; ?>">
                            </div>
