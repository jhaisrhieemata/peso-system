                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                                                     <label for="inputor_no" class="col-form-label"></label>         
                                                                          <input type="text" id="inputor_no" name="or_no"  class="form-control" placeholder="OR NO." >
                                                                     </div>
                                            <div class="form-row">
                                            ...
                                            <div class="form-row">                                                
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" name="street_village" class="form-control" id="inputstreetvillage" placeholder="Purok/Zone No.">
                                                </div>
                                             <div class="form-group col-md-6">
