    ...
    check_login();
		...
		if(isset($_POST['update_scholarship']))
		{
			...
			*/ 
            ...
            if($stmt)
			{
				$success = "Scholarship Details Updated";
			}
			else {
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Update Scholarship</a></li>
                                            <li class="breadcrumb-item active">Manage Update Scholarship </li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Update Scholarship </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">SCHOLARSHIP INFORMATION</h4>
                                        <!--Add Jobseeker Form-->
                                        <form method="post">
                                         <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input required="required" value="<?php echo $row->firstname;?>" type="text" name="firstname" class="form-control"  id="inputfirstname" placeholder="Firts Name">
                                                </div>
                                                <div class="form-group col-md-4">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="date" required="required" value="<?php echo $row->date_of_birth;?>" name="date_of_birth" class="form-control" id="date_of_birth" placeholder="Date of Birth">
                                                </div>
                                               
                                                <div class="form-group col-md-4">
                                                         <label for="ageDisplay_1" class="col-form-label">Age</label>
                                                         <input type="text" required="required"  value="<?php echo $row->age_;?>" name="age_" class="form-control" id="ageDisplay_1">
                                                     </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" value="<?php echo $row->app_municipality;?>" name="app_municipality" class="form-control"  id="inputappmunicipality" value="Manolo Fortich"> 
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" value="<?php echo $row->app_province;?>" name="app_province" class="form-control"  id="inputappprovince" value="Bukidnon"> 
                                                    <!-- <select id="inputappprovince" required="required" name="app_province" class="form-control" value="Bukidnon">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" required="required" value="<?php echo $row->number_of_brother;?>" name="number_of_brother" class="form-control" id="inputnumberofbrother" placeholder="Number of Brother">
                                                </div>
                                            </div> 
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" required="required" value="<?php echo $row->number_of_sister;?>" name="number_of_sister" class="form-control" id="inputnumberofsister" placeholder="Number of Sister">
                                                </div>
                                            </div> 
                                            <div class="form-row">                                                
                                                <div class="form-group col-md-6">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" value="<?php echo $row->elem_year_graduated;?>" name="elem_year_graduated" class="form-control"  id="inputelemyeargraduated" placeholder="Year Graduated">
                                                </div> 
                                            </div>   
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input required="required" type="text" value="<?php echo $row->hs_lastyear_attended;?>" name="hs_lastyear_attended" class="form-control"  id="inputhslastyearattended" placeholder="Last Year Attended">
                                                </div> 
                                                <div class="form-group col-md-4">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" value="<?php echo $row->col_lastyear_attended;?>" name="col_lastyear_attended" class="form-control"  id="inputcollastyearattended" placeholder="Last Year Attended">
                                                </div>  
...
const ageField = document.getElementById("ageDisplay_1");
