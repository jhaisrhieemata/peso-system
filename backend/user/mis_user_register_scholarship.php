                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Create New scholarship </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                         ...
                                         <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="date" required="required" name="date_of_birth" class="form-control" id="date_of_birth" placeholder="Date of Birth">
                                                </div>
                          
                                                <div class="form-group col-md-4" >     
                                                    <label for="ageDisplay" class="col-form-label">Age</label>
                                                    <input type="text" required="required"  name="age_" class="form-control" id="ageDisplay">
                                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" name="app_municipality" class="form-control"  id="inputappmunicipality" value="Manolo Fortich"> 
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" name="app_province" class="form-control"  id="inputappprovince" value="Bukidnon"> 
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" name="col_lastyear_attended" class="form-control"  id="inputcollastyearattended" placeholder="Last Year Attended">
                                                </div>  
...
const ageField = document.getElementById("ageDisplay");
