                                        ...
                                        <div class="form-check">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="inputSuffix" required="required" name="suffix" value="<?php echo $row->suffix;?>" class="form-control" disabled>
                                            ...
                                            <div class="form-row">                                                
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input required="required" type="text" value="<?php echo $row->religion;?>"  name="religion" class="form-control" id="inputReligion" placeholder="Religion"disabled>
                                                </div>
                                             <div class="form-group col-md-4">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input required="required" type="text" value="<?php echo $row->tin;?>"  name="tin" class="form-control" id="inputTIN" placeholder="TIN" disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">                                      
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select id="inputDisability" required="required" name="disability"  class="form-control" disabled>
                                                    <option value="">-Select-</option>
                                              ...
                                              <div class="form-group col-md-4">
                                                <label for="inputHeight" class="col-form-label">Height(ft.)</label>
                                                    <input required="required" type="text" value="<?php echo $row->height;?>" name="height"  class="form-control" id="inputHeight" placeholder="Height" disabled>
                                                </div>
                                                <div class="form-group col-md-4">
                                            ...
                                            <div class="form-row">                                             
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select id="inputAreyouOFW" required="required" name="Are_you_ofw"  class="form-control" disabled>
                                                ...
                                                <label for="inputAreyouaformerOFW" class="col-form-label">Are you a former OFW?</label>
                                                    <select id="inputAreyouaformerOFW" required="required"  name="are_you_a_former_ofw"  class="form-control" disabled>
                                                    <option value="">-Select-</option>
                                                ...
                                                <label for="inputAreyoua4Psbeneficiary" class="col-form-label">Are you a 4Ps beneficiary?</label>
                                                    <select id="inputAreyoua4Psbeneficiary" required="required"  name="beneficiary" class="form-control"disabled>
                                                    <option value="">-Select-</option>
                                            ...
                                            <div class="form-row">
                                             ...
                                             <div class="form-group col-md-4">
                                                <label for="inputLanguage" class="col-form-label">Language/Dialect</label>
                                                    <select id="inputLanguage" required="required" name="language_dialect"  class="form-control" disabled>
                                                    <option value="">-Select-</option>
                                            ...
                                            <div class="form-row">                                      
                                              ...
                                              <div class="form-group col-md-4">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input required="required" type="text" value="<?php echo $row->course;?>" name="course"  class="form-control" id="inputCourse" placeholder="please specify course" disabled>
                                                </div>
                                            </div>
