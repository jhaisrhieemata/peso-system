                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">New SPES </li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Create New SPES </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="date" required="required" name="date_of_birth" class="form-control" id="date_of_birth_2" placeholder="Date of Birth">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label for="ageDisplay_2" class="col-form-label">Age</label>
                                                    <input required="required" type="text" name="age_" class="form-control"  id="ageDisplay_2" placeholder="Age">
                                                </div>
